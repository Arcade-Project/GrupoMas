    ...
    <form method="post" action="agregar.php">
		...
		<form action="ingreso.php" method="POST">
		        <tr>
		            ...
		            <td><input type="text" name="usuariouser" placeholder="Nombre" required/></td><br><br>
		        </tr>
        </form>
        ...
        <select name="comidapreferida" size=1>
            <option value="tortilla">Departamento</option>
            <option value="paella">Casa</option>
            <option value="pizza">Local</option><br><br>
        </select>
